...
$PODS_ROOT/SwiftGen/bin/swiftgen strings "DevStack/Resources/Base.lproj/Localizable.strings" -t flat-swift4 --param publicAccess --output "DevStack/Constants/Localizable.swift"
